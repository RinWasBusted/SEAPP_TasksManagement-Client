...
function Spinner({
    ...
    return (
        <div style={{top , left}} className='absolute '>
            <div className="svg-wrapper flex flex-col items-center justify-center gap-4">
                ...
                */}
                ...
                <div className="loading-text font-semibold text-2xl text-white">Waiting is happiness...</div>
            </div>
        </div>
    )
}
