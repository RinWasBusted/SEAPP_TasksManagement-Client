...
<div
    ...
    onClick={stop}   
>
    <span className="text-center w-[173px] line-clamp-2 wrap-break-word overflow-hidden">
        {name}
    </span>
    <span className="text-center font-normal text-[14px] line-clamp-2">
        {email}
    </span>
</div>
        </div>
