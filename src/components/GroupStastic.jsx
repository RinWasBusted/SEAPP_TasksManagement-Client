...
{
    return (
        <article className={`relative w-[301px] h-[147px] py-7 px-6 border ${additionalStyle} rounded-[23px] border-[#B3B3B3]`}>
            ...
            <div className={`absolute w-[31px] h-[31px] flex items-center stastic-icon justify-center text-sm rounded-2xl top-12 left-[252px]`}>
